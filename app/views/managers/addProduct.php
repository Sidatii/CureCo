...
<form action="<?php echo URLROOT . 'Managers/addProduct'?>" method="POST" enctype="multipart/form-data" class="mx-4 my-4 flex flex-col gap-2 bg-[#F1F1F1] p-3 rounded-lg">
    ...
    <div>
        ...
        <textarea type="text" placeholder="The product discription here" name="disc" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 "></textarea>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="number" name="qty" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 ">
    </div>
    <div>
