<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded-b-xl">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a href="<?php echo URLROOT . 'Pages/index'; ?>" class="flex items-center">
            <img src="<?php echo URLROOT; ?>public/img/CureCo_logo.svg" class="h-6 mr-3 sm:h-9" alt="CureCo Logo">
        </a>
        <div class="flex md:order-2 gap-2">
            ...
            <div class="<?=$_SESSION['guest']; ?>">
                <button type="button" class="text-[#335f91] border-2 border-[#c7e2c8] focus:outline-none font-medium rounded-2xl text-sm px-3 py-1.5 text-center mr-3 md:mr-0 dark:focus:ring-[#335f91] sm:text-[12px] sm:px-2 sm:py-1"><a href="<?php echo URLROOT . 'Users/login'; ?>">Sign In</a></button>

                <button type="button" class="bg-[#c7e2c8] hover:bg-[#c7e2c8] focus:outline-none font-medium rounded-2xl text-sm px-3 py-1.5 text-center mr-3 md:mr-0 dark:bg-[#c7e2c8] dark:hover:bg-[#c7e2c8] dark:focus:ring-[#c7e2c8] text-[#335f91]"><a href="<?php echo URLROOT . 'Users/signup'; ?>">Sign Up</a></button>
            </div>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
            <ul class="flex flex-col p-4 mt-4 border rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  dark:border-[#245BA8]">
                <li>
